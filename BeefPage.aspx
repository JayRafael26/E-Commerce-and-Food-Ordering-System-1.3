<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="BeefPage.aspx.cs" Inherits="MangAtongsPrototype.WebForm5" %>
                ...
                <div class="col col-lg-9">
                    <nav aria-label="breadcrumb" style="padding-top: 10px;">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Beef Products</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="btn-group-vertical">
                            ...
                            <a href="BeefPage.aspx" class="btn btn-link btn-block text-left disabled" role="button" >
							    Beef
                            </a>
                ...
                <div class="container-fluid">
                    <div class="overflow-hidden text-center text-white" style="background-color: #ffb28f;">
                        <div class="col-md-5 p-lg-5 mx-auto" style="padding: 20px 0 20px">
                            <h2 class="display-5 fw-normal" style="font-weight: 800;">Beef Products</h2>
                        </div>
                    </div>
                    <br />
