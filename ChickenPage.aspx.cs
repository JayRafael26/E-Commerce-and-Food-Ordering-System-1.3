...
namespace MangAtongsPrototype
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        private void LoadProducts(){
            DBConnection DB = new DBConnection();
            using (SqlCommand cmd = new SqlCommand("SELECT *, cast(ProductPrice as decimal(10,2)) AS ProdPrice FROM products_tbl where CategoryID=1 AND ProductQuantity > 0", DB.con))
            {
