...
namespace MangAtongsPrototype
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        {
            DBConnection DB = new DBConnection();
            using (SqlCommand cmd = new SqlCommand("SELECT *, cast(ProductPrice as decimal(10,2)) AS ProdPrice FROM products_tbl where CategoryID=3 AND ProductQuantity > 0", DB.con))
            {
