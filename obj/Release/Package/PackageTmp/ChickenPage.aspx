<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ChickenPage.aspx.cs" Inherits="MangAtongsPrototype.WebForm4" %>
                ...
                <div class="col col-lg-9">
                    <nav aria-label="breadcrumb" style="padding-top: 10px;">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Chicken Products</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="btn-group-vertical">
                            <a href="ChickenPage.aspx" class="btn btn-link btn-block text-left disabled" role="button" >
							    Chicken
                            </a>
                            <a href="BeefPage.aspx" class="btn btn-link btn-block text-left" role="button" >
							    Beef
                            </a>
                            <a href="OtherProductsPage.aspx" class="btn btn-link btn-block text-left" role="button" >
							    Other Products
                            </a>
                ...
                <div class="container-fluid">
                    <div class="overflow-hidden text-center text-white" style="background-color: #ffb28f;">
                        <div class="col-md-5 p-lg-5 mx-auto" style="padding: 20px 0 20px">
                            <h2 class="display-5 fw-normal" style="font-weight: 800;">Chicken Products</h2>
                        </div>
                    </div>
                    <br />
